...
if __name__ == '__main__':
	...
	test.run({'name': 'OPF', 'replace': ['mimetype'], 'mimetype': 'application/xml', 'groups': [
		...
		{'name': 'dc-metadata', 'type': 'turtle', 'tests': [
			{'test': 'opf/dc-metadata/dublincore-contributor.opf', 'result': 'opf/dc-metadata/dublincore-contributor.n3'},
			{'test': 'opf/dc-metadata/dublincore-coverage.opf', 'result': 'opf/dc-metadata/dublincore-coverage.n3'},
			{'test': 'opf/dc-metadata/dublincore-creator.opf', 'result': 'opf/dc-metadata/dublincore-creator.n3'},
			{'test': 'opf/dc-metadata/dublincore-date.opf', 'result': 'opf/dc-metadata/dublincore-date.n3'},
			{'test': 'opf/dc-metadata/dublincore-description.opf', 'result': 'opf/dc-metadata/dublincore-description.n3'},
			{'test': 'opf/dc-metadata/dublincore-format.opf', 'result': 'opf/dc-metadata/dublincore-format.n3'},
			{'test': 'opf/dc-metadata/dublincore-identifier.opf', 'result': 'opf/dc-metadata/dublincore-identifier.n3'},
			{'test': 'opf/dc-metadata/dublincore-language.opf', 'result': 'opf/dc-metadata/dublincore-language.n3'},
			{'test': 'opf/dc-metadata/dublincore-publisher.opf', 'result': 'opf/dc-metadata/dublincore-publisher.n3'},
			{'test': 'opf/dc-metadata/dublincore-relation.opf', 'result': 'opf/dc-metadata/dublincore-relation.n3'},
			{'test': 'opf/dc-metadata/dublincore-rights.opf', 'result': 'opf/dc-metadata/dublincore-rights.n3'},
			{'test': 'opf/dc-metadata/dublincore-source.opf', 'result': 'opf/dc-metadata/dublincore-source.n3'},
			{'test': 'opf/dc-metadata/dublincore-subject.opf', 'result': 'opf/dc-metadata/dublincore-subject.n3'},
			{'test': 'opf/dc-metadata/dublincore-title.opf', 'result': 'opf/dc-metadata/dublincore-title.n3'},
			{'test': 'opf/dc-metadata/dublincore-type.opf', 'result': 'opf/dc-metadata/dublincore-type.n3'},
