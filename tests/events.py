...
if __name__ == '__main__':
	...
	test.run({'name': 'HTML', 'groups': [
		...
		{'name': 'sections', 'type': 'events', 'tests': [
			...
			{'test': 'html/sections/headings.html', 'result': 'html/sections/headings.events', 'expect': 'fail'},
			{'test': 'html/sections/headings.xhtml', 'result': 'html/sections/headings.events', 'expect': 'fail'},
