...
if __name__ == '__main__':
	...
	test.run({'name': 'HTML', 'replace': ['title'], 'title': 'unspecified', 'groups': [
		...
		{'name': 'sections', 'type': 'events', 'tests': [
			...
			{'test': 'html/sections/ol-nested.xhtml', 'result': 'html/sections/ol-nested.events', 'expect': 'volatile'},
			...
			{'test': 'html/sections/ul-nested.xhtml', 'result': 'html/sections/ul-nested.events', 'expect': 'volatile'},
		]},
